...
if ( Sukna_Auth::is_admin() ) {
    ...
    <div class="sukna-grid" style="grid-template-columns: 1.5fr 1fr; gap: 20px;">
        <div class="sukna-card" style="border-radius: 12px;">
            <h3 style="color: #000;"><?php _e('عقاراتي المستثمر بها', 'sukna'); ?></h3>
        ...
        <div class="sukna-card" style="border-radius: 12px;">
            <h3 style="color: #000;"><?php _e('آخر الحركات المالية', 'sukna'); ?></h3>
                ...
                <?php foreach($transactions as $t): ?>
                    <div style="padding: 10px 0; border-bottom: 1px solid #e2e8f0; display:flex; justify-content: space-between; align-items: center;">
                        <div>
                            ...
                            <span style="font-size:0.85rem; font-weight: 600;"><?php echo esc_html($t->description); ?></span>
                        </div>
