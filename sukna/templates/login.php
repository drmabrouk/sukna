    ...
    <div class="sukna-auth-card">
        ...
        <div style="text-align:center; margin-bottom:35px;">
            <?php
                ...
                <?php endif;
            ?>
            <p style="color:#64748b; margin-top:10px; font-weight:600;"><?php _e('مرحباً بكم في سكنى', 'sukna'); ?></p>
        </div>
            ...
            <form id="sukna-login-form">
                <div class="sukna-form-group">
                    <div class="phone-input-group">
                        ...
                        <input type="tel" name="phone_body" id="login-phone-body" placeholder="<?php _e('رقم الهاتف', 'sukna'); ?>" required>
                        <input type="hidden" name="phone" id="login-phone-full">
                    </div>
                </div>

                <div class="sukna-form-group">
                    <input type="password" name="password" required placeholder="<?php _e('كلمة المرور', 'sukna'); ?>">
                </div>
                ...
                <button type="submit" class="sukna-btn sukna-btn-accent" style="width:100%; height:55px; font-size:1.1rem; border-radius:10px;">
            ...
            <form id="sukna-register-form">
                <div id="reg-step-1" class="reg-step">
                    <div style="display:flex; gap:10px; margin-bottom:20px;">
                        <input type="text" name="first_name" placeholder="<?php _e('الاسم الأول', 'sukna'); ?>" required>
                        <input type="text" name="last_name" placeholder="<?php _e('اسم العائلة', 'sukna'); ?>" required>
                    </div>
                </div>
                ...
                <div id="reg-step-2" class="reg-step" style="display:none;">
                    <div class="sukna-form-group">
                        <div class="phone-input-group">
                            ...
                            <input type="tel" name="phone_body" id="reg-phone-body" placeholder="<?php _e('رقم الهاتف', 'sukna'); ?>" required>
                        </div>
                    </div>
                </div>
                ...
                <div id="reg-step-3" class="reg-step" style="display:none;">
                    <div class="sukna-form-group">
                        <input type="email" name="email" placeholder="<?php _e('البريد الإلكتروني (اختياري)', 'sukna'); ?>">
                    </div>
                </div>

                <div id="reg-step-4" class="reg-step" style="display:none;">
                    <div class="sukna-form-group">
                        <input type="password" name="password" id="reg-password" placeholder="<?php _e('كلمة المرور (8 أحرف على الأقل)', 'sukna'); ?>" required>
                    </div>
                </div>
                ...
                <div style="display:flex; gap:10px; margin-top:20px;">
                    <button type="button" id="reg-prev" class="sukna-btn" style="flex:1; display:none; background:#222; border:none;"><?php _e('السابق', 'sukna'); ?></button>
                    <button type="button" id="reg-next" class="sukna-btn sukna-btn-accent" style="flex:2; border-radius: 8px;"><?php _e('التالي', 'sukna'); ?></button>
                    <button type="submit" id="reg-submit" class="sukna-btn sukna-btn-accent" style="flex:2; display:none; border-radius: 8px;"><?php _e('إتمام التسجيل', 'sukna'); ?></button>
                </div>
