    ...
    <div class="pdf-report-body">
        ...
        <div class="pdf-page">
            ...
            <div class="analysis-note">
                <strong><?php _e('تحليل النظام:', 'sukna'); ?></strong> <?php _e('يوضح هذا القسم المواصفات الأساسية للعقار والهيكل المالي للاستثمار. يتم احتساب إجمالي رأس المال بناءً على القيمة الاسمية مضافاً إليها كافة التكاليف التأسيسية والرسوم التنظيمية لضمان دقة حساب العائد ROI الفعلي.', 'sukna'); ?>
            </div>
            ...
            <div class="analysis-note">
                <?php _e('يعتمد النظام توزيع الملكية التلقائي بناءً على الحصة النقدية المساهم بها في إجمالي تكلفة المشروع. يتم احتساب الأرباح الشهرية المستحقة لكل شريك بناءً على هذه النسبة من صافي الدخل التشغيلي بعد استقطاع المصاريف.', 'sukna'); ?>
            </div>
        ...
        <div class="pdf-page">
            ...
            <div class="analysis-note" style="background: #000; color: #fff;">
                <strong><?php _e('مذكرة مالية:', 'sukna'); ?></strong> <?php _e('معدل العائد على الاستثمار (ROI) المعروض هو معدل سنوي تراكمي يتم تحديثه لحظياً مع كل دفعة إيجار محصلة. صافي الربح هو الناتج الفعلي بعد استقطاع كافة المصاريف التشغيلية (OPEX) المسجلة في النظام.', 'sukna'); ?>
            </div>
        ...
        <div class="pdf-page">
            ...
            <div class="analysis-note">
                <?php _e('يوضح الجدول التالي الحالة اللحظية لكل وحدة إيجارية داخل العقار. يتم مراقبة الإشغال دورياً لضمان أعلى معدلات تشغيل ممكنة وتقليل فترات الشغور لتحسين التدفق النقدي.', 'sukna'); ?>
            </div>
